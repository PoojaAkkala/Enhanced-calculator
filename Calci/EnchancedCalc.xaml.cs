...
public partial class Enhancedcalc : ContentPage
{
	public Enhancedcalc()
	{
		InitializeComponent();
    ...
    void OnCalculate(object sender, EventArgs e)
    {
        if (currentState == 2)
        {
            ...
            double result = Calci.Calculate(firstNumber, secondNumber, mathOperator);
    ...
    void OnLeftParenthisis(object sender, EventArgs e)
    {
        if (currentState == 1)
        {
            LockNumberValue(resultText.Text);
    ...
    void OnRightParenthisis(object sender, EventArgs e)
    {
        Button button = (Button)sender;
        string pressed = button.Text;
